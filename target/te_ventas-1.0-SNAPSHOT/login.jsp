...
<html lang="en" data-bs-theme="auto">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="LoginControlador" method="post">
            <img class="mb-4" src="https://vicerrectorado.upea.bo/uploads/a125.png" alt="" width="72" height="72">
            <h1 class="">Login</h1>
            ...
            <p class="mt-5 mb-3 text-body-secondary">&copy;Hernan Callizaya Cori.</p>
                <p class="mt-1 mb-3 text-body-secondary">Tecnologias Emergentes TEM-742</p>
        </form>
    </main>
